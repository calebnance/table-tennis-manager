	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<div class="filter-area form-inline">
				...
				<div class="table-responsive">
					<table class="table table-striped">
						<thead>
							<tr>
								<th class="text-right"><a href="#" class="btn btn-default btn-xs pull-left"><span class="glyphicon glyphicon-sort-by-order"></span></a> ID<span class="clearfix"></span></th>
